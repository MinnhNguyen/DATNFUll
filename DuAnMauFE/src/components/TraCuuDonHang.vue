<template>
  <div class="tracking-container">
    ...
    <div class="tracking-content">
      ...
      <div class="tracking-search">
        <a-form layout="vertical" @finish="timKiemDonHang">
          <a-form-item label="Mã đơn hàng / Mã vận đơn" name="trackingCode">
            <a-input v-model:value="trackingCode" placeholder="Nhập mã đơn hàng hoặc mã vận đơn" :maxLength="50"
              :allowClear="true" size="large" />
          </a-form-item>
          <a-form-item>
            <a-button type="primary" html-type="submit" @click="timKiemDonHang" :loading="dangTai" size="large" block>
        ...
        <div v-else class="order-details">
          <div class="order-header">
            ...
            <div :class="['order-status', `status-${currentStatus?.code || 'pending'}`]">
              <component :is="layBieuTuongTrangThai(currentStatus?.code || 'pending')" class="status-icon" />
          ...
          <div class="order-summary">
            ...
            <div class="shipping-info">
              ...
              <div class="info-row" v-if="donHang.deliveryService">
                ...
                <span class="info-value">MenWear</span>
              </div>
      ...
      <!-- TODO: Implement PrintInvoice component -->
