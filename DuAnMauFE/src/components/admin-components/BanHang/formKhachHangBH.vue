          ...
          <a-row :gutter="16">
            <a-col :span="8">
              <a-form-item label="Họ tên khách hàng" :validate-status="errors.tenKhachHang ? 'error' : ''"
                ...
                <a-input v-model:value="formData.tenKhachHang" placeholder="Nhập tên khách hàng" class="custom-input"
                  size="large" />
              </a-form-item>
            </a-col>
            ...
            <a-col :span="8">
              <a-form-item label="Số điện thoại" :validate-status="errors.soDienThoai ? 'error' : ''"
                ...
                <a-input v-model:value="formData.soDienThoai" placeholder="Nhập số điện thoại" class="custom-input"
                  size="large" />
              </a-form-item>
            </a-col>
            ...
            <a-col :span="8">
              <a-form-item label="Email" :validate-status="errors.email ? 'error' : ''" :help="errors.email">
                <a-input v-model:value="formData.email" placeholder="Nhập email" class="custom-input" size="large" />
              </a-form-item>
            </a-col>
          </a-row>
        </div>
          ...
          <a-row :gutter="16">
            <a-col :span="6">
              <a-form-item label="Tỉnh/Thành phố"
                ...
                <a-select v-model:value="diaChi.tinhThanhPho" placeholder="Chọn Tỉnh/Thành phố" class="custom-select"
                  size="large" @change="() => handleProvinceChange(index)">
            ...
            <a-col :span="6">
              <a-form-item label="Quận/Huyện" :validate-status="errors.diaChiErrors[index]?.quanHuyen ? 'error' : ''"
                ...
                <a-select v-model:value="diaChi.quanHuyen" placeholder="Chọn Quận/Huyện" class="custom-select"
                  size="large" :disabled="!diaChi.tinhThanhPho" @change="() => handleDistrictChange(index)">
            ...
            <a-col :span="6">
              <a-form-item label="Phường/Xã" :validate-status="errors.diaChiErrors[index]?.xaPhuong ? 'error' : ''"
                ...
                <a-select v-model:value="diaChi.xaPhuong" placeholder="Chọn Phường/Xã" class="custom-select"
                  size="large" :disabled="!diaChi.quanHuyen" @change="() => handleWardChange(index)">
            ...
            <a-col :span="6">
              <a-form-item label="Số nhà, tên đường" :validate-status="errors.diaChiErrors[index]?.soNha ? 'error' : ''"
                ...
                <a-input v-model:value="diaChi.soNha" placeholder="Số nhà, tên đường..." class="custom-input"
                  size="large" />
              </a-form-item>
            </a-col>
          </a-row>
...
const luuThongTinKhachHang = async () => {
  ...
  try {
    ...
    const customerData = {
      ...
      sdt_nguoi_nhan: formData.soDienThoai,
...
onMounted(async () => {
  ...
  if (idHoaDon) {
    ...
    if (hoaDon && hoaDon.ho_ten && hoaDon.sdt) {
      ...
      formData.soDienThoai = hoaDon.sdt_nguoi_nhan;
  ...
  if (walkInCustomer) {
    try {
      ...
      formData.soDienThoai = customer.sdt_nguoi_nhan || '';
