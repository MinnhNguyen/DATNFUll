        ...
        <a-card title="Tỉ lệ trạng thái đơn hàng" :bordered="false">
          <a-spin :spinning="gbStore.loading">
            <div id="orderStatusChart">
              <apexchart type="pie" :options="chartOptionTiLeTrangThai" :series="chartSeries" height="380" />
            </div>
          </a-spin>
        </a-card>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <a-card :bordered="false">
            ...
            <div class="d-flex justify-content-between align-items-center">
              ...
              <div class="filter-section d-flex gap-3">
                ...
                <a-range-picker v-model:value="sellingDateRange" @change="handleSellingDateChange"
                  :placeholder="['Start date', 'End date']" :locale="locale" style="margin-left: 10px;" />
          ...
          <a-table :columns="columns" :data-source="gbStore.topSanPhamBanChay" :pagination="false" size="small">
      ...
      <div class="col-md-6">
        <a-card :bordered="false">
          ...
          <a-table :columns="columns" :data-source="gbStore.topSanPhamSapHetHang" :pagination="false" size="small">
            <template #bodyCell="{ column, text, index }">
              <template v-if="column.key === 'stt'">
                <a-tag :color="getTagColor(index + 1)">
                  {{ getTopRank(index + 1) }}
