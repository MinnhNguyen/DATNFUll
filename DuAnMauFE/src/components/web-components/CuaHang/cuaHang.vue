<template>
  <div class="store-about">
        ...
        <a-row :gutter="[16, 16]" class="mt-5">
          <a-col :xs="24" :sm="12" :md="8">
            <div class="gallery-item">
              <img
                src="https://lh7-us.googleusercontent.com/o2OVt-take0S7RfSVCwbvhUxe-7k6rmvj3rxKsFQrLCTXoqSBE8FqUssZ4w8z1pwBrjyrcxKXOdO-HTP1IehAslP4Rk838Fr4918gCEgWD4hPCFRzi5uKQZLRiGgp3VOAFyVbQxwxeG86WcYNW_5Es8"
          ...
          <a-col :xs="24" :sm="12" :md="8">
            <div class="gallery-item">
              <img
                src="https://file.hstatic.net/1000360022/file/dia-chi-ban-ao-so-mi-nam-dep-aristino_cc6b009ade4443ad852b1c7ee1c2466c.jpg"
                alt="Cửa hàng G&B SPORTS" />
            </div>
          </a-col>
          <a-col :xs="24" :sm="12" :md="8">
            <div class="gallery-item">
              <img
                src="https://lh7-us.googleusercontent.com/bR5n81OOyEo2pbU4VazVHrqdmWzW81bt4fvnqJgADhEylQobXMCU9l5CSV0Lzedtmj6ogWq0wF58YjH1c5aXFrtAOna7SsEIVLF-gLdXBXbVGIiCMXcYRZ6ki7vA7HoXsz_7s7k6Iy-TKVJECLa6nmE"
                alt="Cửa hàng MenWear" />
            </div>
          </a-col>
        </a-row>
      </div>
    ...
    <section class="testimonials-section container" ref="testimonialsRef" :class="{ 'visible': testimonialsVisible }">
