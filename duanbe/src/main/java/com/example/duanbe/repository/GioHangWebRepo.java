  ...
  @Query(nativeQuery = true, value = """
      WITH khuyen_mai_tot_nhat AS (
          SELECT
              ...
              (
                  ...
                  WHERE ctkm2.id_chi_tiet_san_pham = ctkm.id_chi_tiet_san_pham
                    ...
                    AND km2.ngay_bat_dau <= SYSDATETIMEOFFSET()
                    AND km2.ngay_het_han >= SYSDATETIMEOFFSET()
          ...
          WHERE km.trang_thai = N'Đang diễn ra'
            AND km.ngay_bat_dau <= SYSDATETIMEOFFSET()
            AND km.ngay_het_han >= SYSDATETIMEOFFSET()
